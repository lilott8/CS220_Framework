...
vector<LeeNode> Lee2Bit::get_adjacent_coordinates(LeeNode c, int iteration) {
...
LeeNode Lee2Bit::calculate_metric(LeeNode a, int iteration) {
    LeeNode temp = a;
    ...
    if (dist % 3 == 0) {
        ...
        kMap->get_map()->at(a.get_x()).at(a.get_y())->set_lee2bitwave(3);
        ...
        kMap->get_map()->at(a.get_x()).at(a.get_y())->set_leewave(dist);
        kMap->get_map()->at(a.get_x()).at(a.get_y())->set_lee2bitwave(dist % 3);
